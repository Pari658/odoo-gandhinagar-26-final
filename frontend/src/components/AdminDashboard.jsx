...
export default function AdminDashboard({ onNavigate }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-5 rounded-2xl bg-white dark:bg-[#1C1613] border border-[#E6DFD5] dark:border-[#382D27] shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="p-2.5 rounded-xl bg-emerald-100 dark:bg-emerald-950/60 text-emerald-700 dark:text-emerald-300">
            <Database className="w-5 h-5" />
          </div>
          <div>
            <h4 className="text-xs font-bold text-[#2C221E] dark:text-[#F5EFE6]">
              Supabase PostgreSQL Database Connected
            </h4>
            <p className="text-[11px] text-[#6B5E55] dark:text-[#A89B91]">
              Host: <span className="font-mono">db.dzvcrojwshwjkytcozlz.supabase.co</span> • Port: 5432 • Strict ACID & Balance Triggers Enforced
            </p>
          </div>
        </div>

        <div className="flex items-center gap-2">
          <span className="px-3 py-1 rounded-full text-xs font-semibold bg-emerald-50 text-emerald-800 border border-emerald-200 dark:bg-emerald-950/60 dark:text-emerald-300 dark:border-emerald-800">
            ● Database Live
          </span>
        </div>
      </div>
